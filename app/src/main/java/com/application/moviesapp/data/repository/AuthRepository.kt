...
class AuthRepositoryImpl @Inject constructor(
    ...
    override fun signIn(
        ...
        val result =
            auth.startActivityForSignInWithProvider(activity ?: throw Throwable(), provider.build())
                .await()
...
class SignInEmailRepositoryImpl @Inject constructor(
    private val context: Context,
    private val auth: FirebaseAuth
) : AuthRepository {
...
class SignUpEmailRepositoryImpl @Inject constructor(
    private val context: Context,
    private val auth: FirebaseAuth
) : AuthRepository {
    ...
    override fun signIn(
        ...
        val result =
            auth.createUserWithEmailAndPassword(email.toString(), password.toString()).await()
